<?php
	...
	{
		// keine HTML-Tags erlaubt außer b, i und br
		$value = strip_tags($value, '<b><i><br>');

		// HTML-Tags maskieren
		$value = htmlentities($value, ENT_QUOTES, 'ISO8859-1');
		
		// Erlaubte HTML-Tags dokodieren
		$value = html_entity_decode($value, ENT_QUOTES, 'ISO8859-1');
